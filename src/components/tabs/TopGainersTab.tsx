...
export const TopGainersTab: React.FC<TopGainersTabProps> = ({ onSelectCoin }) => {
  const { coins, loading, error, refresh, loadMore, hasMore } = useCoinsList('gainers');

  if (loading && coins.length === 0) {
    return <LoadingIndicator message="Loading top gainers..." />;
  }
