...
export const FeaturedTab: React.FC<FeaturedTabProps> = ({ onSelectCoin }) => {
  const { coins, loading, error, refresh, loadMore, hasMore } = useCoinsList('featured');

  if (loading && coins.length === 0) {
    return <LoadingIndicator message="Loading top cryptocurrencies..." />;
  }
